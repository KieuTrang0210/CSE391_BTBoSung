            ...
            <div class="row my-1">
                ...
                <div class="col-md-2">
                    ...
                    <form class="d-flex" role="search">
                        ...
                        <button class="bg-light border-0" type="submit"><i class="bi bi-search"></i></button>
                    </form>
                </div>
                <div class="col-md-1"></div>
            </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu bg-dark mt-2 py-0 d-flex border-0" aria-labelledby="navbarDropdown">
                                            <li class="border-end border-2 p-1">
                                                <Link class="dropdown-item text-white py-0 lh-lg bg-danger" to="#">Khoa</Link>
                                                <ul class="ps-0 list-unstyled">
                                                    <li><Link class="dropdown-item text-white py-0 lh-lg" to="#">Khoa học máy tính</Link></li>
                                                    <hr class="dropdown-divider bg-secondary my-0" />
                                                    <li><Link class="dropdown-item text-white py-0" to="#">Kỹ thuật Máy tính</Link></li>
                                                </ul>
                                            </li>

                                            <li class="p-1">
                                                <Link class="dropdown-item text-white py-0 lh-lg bg-danger">Trung tâm</Link>
                                                <ul class="ps-0">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu bg-dark mt-2 py-0 d-flex border-0" aria-labelledby="navbarDropdown">
                                            <li class="border-end border-2 p-1">
                                                <Link class="dropdown-item text-white py-0 lh-lg bg-danger" to="/news">Tin tức</Link>
                                                <ul class="ps-0 list-unstyled">
                                                    <li><Link class="dropdown-item text-white py-0 lh-lg" to="#">Thông báo</Link></li>
                                                    <hr class="dropdown-divider bg-secondary my-0" />
                                                    <li><Link class="dropdown-item text-white py-0" to="#">Tin bài</Link></li>
                                                    <hr class="dropdown-divider bg-secondary my-0" />
                                                    <li><Link class="dropdown-item text-white py-0" to="#">SoICT Talks</Link></li>
                                                </ul>
                                            </li>

                                            <li class="p-1">
                                                <Link class="dropdown-item text-white py-0 lh-lg bg-danger">Sự kiện</Link>
                                                <ul class="ps-0">
